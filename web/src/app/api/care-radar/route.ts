...
const schema = {
  ...
  properties: {
    ...
    guestReply: { type: Type.STRING, description: "A warm, calibrated line a staff member could say or send to this guest, max 40 words. Match their emotional register — never a templated greeting." },
  ...
  required: ["emotion", "intensity", "occasion", "unspokenNeed", "evidence", "careBrief", "doNow", "restraint", "guestReply", "sensitivityFlag"],
};
